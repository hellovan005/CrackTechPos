...
<div style="height:20px">&nbsp;</div>
<div>Xem lãi theo: </div>
<select id="cboLaiTheo" name="cboLaiTheo">
<option value="GIANHAP">Giá nhập</option>
<option value="GIAVON">Giá vốn</option>
</select>
<div align="right">
...
$(function() {	
	...
	$("#btnXem").click(function(e) {
       window.location = 'chitiettheomathang?fromDay=' + $("#txtFromDay").val() +
