...
<script type="text/javascript" language='javascript' src="js/utils.js"></script><style>
.col1
{
	width:80px; 
...
<div data-role="header" data-theme="b" data-position="inline">
		...
		<h1>Tổng hợp thu chi theo lý do</h1>
</div>
...
<li data-role="list-divider">Tổng hợp thu chi theo lý do</li>
[DATA]
</ul>
<div align="right">
